...
const treasure = (location) => {
    if (location === infinityStone) {
        document.getElementById(location).innerHTML = "YOU FOUND THE INFINITY STONE! 💎"
        setTimeout(3000)
        alert("Now go bring everyone back.")
        window.location.reload()
    } else if (location === thanos) {
        document.getElementById(location).innerHTML = "Thanos is here. You fight him and lose. ☠"
        setTimeout(3000)
